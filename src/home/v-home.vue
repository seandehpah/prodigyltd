  ...
  <div>
    ...
    <!-- <section v-if="setting('home.logos')" class="section-2 bg-gray-100 px-8 py-12">
      <div class="max-w-6xl mx-auto">
        <h1
          v-if="section2Title"
          class="custom-uppercase text-center text-blue-500"
        >{{ section2Title }}</h1>
    ...
    <section
      ...
      class="section-3 relative bg-cover bg-center bg-blue-900 px-8 py-16"
    >
      <div
        v-if="section3Items"
      ...
      >
        ...
        >
          <div class="p-5 flex flex-col justify-center">
            ...
            <h2
              v-if="item.title"
              class="font-normal text-center tracking-tight text-3xl text-blue-900"
            >
              {{ item.title }}
            </h2>
            <!-- <div
    ...
    >
      ...
      >
        <div class="flex flex-col p-8 justify-center md:w-3/5">
          <h3 v-if="section4Pretitle" class="custom-uppercase text-blue-500">
            {{ section4Pretitle }}
          </h3>
          <h1
            v-if="section4Title"
        ...
        <div class="flex flex-col md:flex-row md:flex-wrap">
          <div class="pb-12 md:w-full">
            ...
            <div class="flex items-center justify-center">
              <h1
                v-if="section5Title"
                class="font-normal tracking-tight text-center text-3xl lg:text-4xl text-blue-900"
              >
                {{ section5Title }}
                <img
          ...
          <div
            v-if="section5Items"
            class="relative z-10 pb-8 md:pb-0 md:pr-8 md:w-3/5"
          >
    ...
    >
      <div class="max-w-6xl mx-auto px-8 py-16 lg:py-24">
        <div class="max-w-xs mx-auto">
          ...
          <h1
            v-if="section6Title"
            class="mt-2 text-normal tracking-tight leading-tight text-3xl text-center text-blue-900 lg:text-4xl"
          >
            {{ section6Title }}
          </h1>
        </div>
          ...
          <template v-for="(item, index) in section6Items">
            <div :key="index" class="w-full p-8 md:w-1/2">
              <blockquote v-if="item.content" class="relative inline-block">
                <span
                  class="absolute text-6xl text-blue-600 font-serif -ml-10 -mt-6"
                  >&ldquo;</span
                >
                <span
                  v-formatted-text="item.content"
