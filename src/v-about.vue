  ...
  <main class="bg-gray-100">
    ...
    >
      <template v-slot:hero-content>
        <div
          v-formatted-text="aboutHeroContent"
    ...
    <section class="max-w-6xl mx-auto px-4 py-16 md:px-8">
      <div class="flex flex-col md:flex-row md:flex-wrap">
        <div class="w-full flex justify-center align-content-center lg:w-2/5">
          <img
        ...
        <div class="w-full pt-8 lg:pt-0 md:pl-16 lg:w-3/5">
          ...
          >
            <h2
              class="font-normal tracking-tight leading-tight text-2xl text-blue-500 md:text-3xl"
            >
          ...
          <div
            ...
            class="rounded-lg -mt-8 p-8 pt-12 border-solid border-2 border-blue-500 flex flex-col md:flex-row md:flex-wrap"
          >
            <div
            ...
            >
              <h2
                v-if="item.title"
                class="font-normal tracking-tight text-2xl text-blue-900"
              >
                {{ item.title }}
              </h2>
              <div
      ...
      <div class="max-w-6xl mx-auto px-8">
        <div class="max-w-4xl mx-auto pb-6 text-center md:pb-12 md:w-full">
          <h3
            ...
            class="custom-uppercase text-blue-500"
          />
          <h1
            v-if="aboutTeamTitle"
            v-formatted-text="aboutTeamTitle"
            class="font-normal tracking-tight text-3xl lg:text-4xl text-blue-900"
          />
        </div>
          ...
          >
            ...
            <div class="w-full bg-gray-100 md:w-3/5">
              <h2
                ...
                class="block text-left custom-uppercase mb-0 text-blue-500"
              />
              <h1
                v-if="member.name"
              ...
              <div class="transition-all flex mt-4 -ml-2">
                <template v-for="(item, i) in member.links">
                  <factor-link
                    ...
                    :event="item.event"
                    :target="item.target"
                    class="transition-all mx-2 h-8 w-8 rounded leading-loose text-center shadow-lg hover:text-blue-500 hover:bg-white"
                  >
