...
.factor-app {
  .contact-form {
    .input-wrap .label {
      @apply font-normal leading-tight text-lg text-blue-900;
    }
    input[type='email'],
    input[type='password'],
    input[type='search'],
    ...
    .form-submit {
      @apply m-0;
      button {
        @apply inline-block px-5 py-3 font-sans font-semibold text-sm leading-tight tracking-widest uppercase rounded text-blue-100 bg-blue-500;
      }
    }
  }
}
