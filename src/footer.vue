<template>
  <footer class="bg-blue-900 text-gray-200 p-8 lg:px-4">
    <div
      class="relative max-w-6xl mx-auto flex flex-col md:flex-row justify-between"
    >
      <figure
        v-if="footerFigure"
      ...
      <div>
        <factor-link v-if="footerLogoInverse" path="/">
          <!-- <img
            ...
            class="h-8"
          /> -->
          <span class="h-8" v-html="footerLogoInverse"></span>
        </factor-link>
        <factor-link v-else-if="footerLogo" path="/">
          <!-- <img
            ...
            class="h-8"
          /> -->
          <span class="h-8" v-html="footerLogo"></span>
        </factor-link>
        <!-- <factor-link v-else-if="footerLogoText" path="/">
          <span v-html="footerLogoText"></span>
        </factor-link> -->
      </div>
      <nav
        v-if="footerNav"
        class="mt-8 w-full flex flex-wrap md:block md:w-auto md:mt-0"
      >
    ...
    <div
      class="max-w-6xl mx-auto pt-8 flex items-center justify-between text-gray-500"
    >
...
export default {
  ...
  data() {
    return {
      ...
      // footerLogoText: setting('site.logoText'),
