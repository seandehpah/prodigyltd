<template>
  <div class="mt-4 border border-transparent">
    <h2 class="block text-left custom-uppercase mb-0 text-blue-500">
      {{ title }}
    </h2>
    <a
      v-if="hasContentSlot"
      href="#"
      class="flex justify-between items-center no-underline text-blue-900 hover:text-blue-500"
      @click.prevent="active = !active"
    >
      <h1 class="block text-left font-normal tracking-tight text-2xl">
        {{ name }}
      </h1>
