          ...
          <div :key="index" class="w-full mt-4 md:-mt-32 md:w-4/12">
            ...
            >
              <div class="px-8 py-4">
                <h1
                  v-if="item.name"
                  class="font-normal tracking-tight leading-tight text-3xl text-blue-900 lg:text-4xl"
                >
                  {{ item.name }}
                </h1>
                <p
              ...
              <ul class="text-base lg:text-lg">
                <li
                  ...
                  class="px-8 py-4 text-3xl font-normal tracking-tight leading-tight text-blue-900 bg-gray-100"
                />
    ...
    <section v-if="setting('pricing.faq')" class="py-8 lg:py-12 bg-white">
      <div class="max-w-3xl mx-auto">
        <h3
          ...
          class="font-normal leading-tight tracking-tight text-center text-3xl lg:text-4xl text-blue-900"
        >
